...
private:
    ...
    void ParseLine(const std::string &line, int lineNum, std::vector<std::string> &errors);
    void AddRule(const std::string &pkgName, FpsRule rule);
    void SetTunable(const std::string &tunable, const std::string &value, int lineNum,
                    std::vector<std::string> &errors);
    std::vector<std::string> FindInvalidRules(void);
    ...
    bool ApplyRefreshRate(const std::string &hzStr, bool force);
